...
<template>
  <div class="tw-w-full dark:tw-bg-gray-900 tw-rounded">
    ...
    <div v-else>
      ...
      <div v-if="matchDetail" class="tw-pt-16">
        ...
        <q-tabs v-model="tabValue" inline-label outside-arrows mobile-arrows narrow-indicator indicator-color="positive" no-caps
        ...
        <q-list class="tw-p-4">
          <q-expansion-item v-for="market in filteredMarkets"  default-opened dense dense-toggle expand-separator
            :label="market.marketName"
            class="dark:tw-bg-gray-800 dark:tw-text-white tw-text-gray-700 tw-mb-2 tw-border dark:tw-border-none tw-p-2"
