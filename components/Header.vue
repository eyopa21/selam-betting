  ...
  <div class="tw-flex tw-justify-between items-center tw-py-1">
    ...
    <div class="lg:tw-flex tw-justify-center tw-items-start tw-hidden">
      <ul v-for="option in menuOptions" :key="option.name">
        <a :href="option.link"
          class="tw-font-semibold hover:tw-underline hover:tw-text-primary-300 tw-underline-offset-4 tw-mx-2 tw-whitespace-nowrap">
          {{ option.name }}
        </a>
      </ul>
    </div>
    <div class="tw-my-auto lg:tw-flex lg:tw-justify-between tw-gap-2 tw-hidden tw-mr-4 tw-items-center">
      ...
      <div v-if="$authentication.loggedIn.value"
        class="tw-my-auto lg:tw-flex lg:tw-justify-between tw-gap-2 tw-hidden tw-mr-4 tw-items-center">
