    ...
    <q-dialog v-model="props.showDialog">
      <q-card>
        ...
        <q-card-actions align="right">
          <q-btn v-close-popup :disabled="props.loading" flat label="Decline" color="primary" @click="emit('close')" />
          <q-btn
            v-close-popup :loading="props.loading" flat label="Accept And Book" color="primary"
            @click="emit('confirm')"
          />
        </q-card-actions>
      </q-card>
