...
import type { Tournaments, Tournament } from '~/types/tournaments'
...
const getTournamentForSport = async (country: PopularCountries, index: number) => {
...
<template>
    ...
    <div class="tw-mx-2">
        <q-expansion-item v-for="(i, key) in countries" :key="i.id" :icon="i.icon" dense bordered
