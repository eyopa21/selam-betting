<template>
  <section class="tw-rounded-lg tw-bg-blue-50 tw-px-4 tw-py-16 sm:tw-px-8 ">
    <div class="tw-mx-auto tw-flex tw-max-w-4xl tw-flex-col tw-gap-8 sm:tw-flex-row">
      <!-- Contact Information -->
      <div class="tw-flex-1">
        <h2 class="tw-mb-6 tw-text-3xl tw-font-bold tw-text-gray-800">
          Contacts
        </h2>
      ...
      <!-- Illustration (example placeholder) -->
      <div class="tw-flex tw-flex-1 tw-items-center tw-justify-center ">
        <div class="tw-relative tw-h-64 tw-w-64 tw-rounded-lg tw-bg-white tw-p-6 tw-shadow-lg">
          <!-- Chat bubbles and icons can be customized here -->
          <div class="tw-absolute tw-right-4 tw-top-4 tw-h-6 tw-w-6 tw-rounded-full tw-bg-green-500" />
          <div class="tw-absolute tw-left-4 tw-top-12 tw-h-10 tw-w-24 tw-rounded-md tw-bg-gray-100" />
          <div class="tw-absolute tw-bottom-8 tw-left-8 tw-h-10 tw-w-32 tw-rounded-md tw-bg-gray-100" />
          <div class="tw-absolute tw-bottom-4 tw-right-4 tw-flex tw-h-10 tw-w-10 tw-items-center tw-justify-center tw-rounded-full tw-bg-blue-500 tw-text-white">
            📧
          </div>
          <div class="tw-absolute tw-right-8 tw-top-20 tw-h-6 tw-w-6 tw-rotate-45 tw-transform tw-bg-blue-500" />
        </div>
      </div>
    </div>
  </section>
