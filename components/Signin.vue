  ...
  <q-dialog v-model="visible" @hide="$emit('modalClosed')">
    <q-card class="tw-p-8 tw-w-96">
      <q-icon
        ...
        v-close-popup
      />
      <div v-if="!isForgotPwd && !isOtp">
        <h3 class="tw-text-2xl tw-font-bold tw-text-primary-700 tw-text-center">
          Sign In
        </h3>
        <div
          class="tw-flex tw-items-center tw-justify-between tw-my-4 tw-gap-4"
        >
          <q-btn
            label="By phone"
            icon="phone"
        ...
        <q-form @submit="onSubmit" class="q-gutter-md tw-my-8">
          ...
          <div class="tw-flex tw-justify-between tw-items-center">
            ...
            <p
              class="tw-text-red-400 tw-cursor-pointer"
              @click="isForgotPwd = true"
            >
              Forgot password?
            </p>
          </div>
          ...
          />
          <p
            class="tw-text-gray-500 tw-font-semibold tw-text-xs tw-text-center"
          >
